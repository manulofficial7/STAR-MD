...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            let textw = "";
            textw += `*🌟ᴍᴀɴᴜ-ᴍᴅ⁹⁹⁹ ᴡᴇᴀᴛʜᴇʀ ʀᴇᴘᴏʀᴛ ᴏғ  ${text}*\n\n`;
...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        google({ 'query': text}).then(res => {
            let msg= `ᴍᴀɴᴜ-ᴍᴅ⁹⁹⁹🔍ɢᴏᴏɢʟᴇ sᴇᴀʀᴄʜ  : ${text} \n\n`;
            for (let g of res) {
                msg+= `📌 Title : ${g.title}\n`;
...
cmd({
    ...
    async(Void, citel, text) => {
        ...
        for (let i = 0; i < parseInt(name2); i++) {
            ...
            await Void.sendMessage(citel.chat, {image: {  url: images,}, caption: `_ᴍᴀɴᴜ-ᴍᴅ⁹⁹⁹ ɪᴍᴀɢᴇ ᴅᴏᴡɴʟᴏᴅᴇʀ_\n*${name1}*`,}, { quoted: citel, });
        }
    }
)
...
cmd({
        ...
        async(Void, citel, text) => {
            ...
            Void.sendMessage(citel.chat, { image: { url: random.male }, caption: `ᴍᴀɴᴜ-ᴍᴅ⁹⁹⁹ ɪᴍᴀɢᴇ ᴅᴏᴡɴʟᴏᴅᴇʀ` }, { quoted: citel })
            Void.sendMessage(citel.chat, { image: { url: random.female }, caption: `ᴍᴀɴᴜ-ᴍᴅ⁹⁹⁹ ɪᴍᴀɢᴇ ᴅᴏᴡɴʟᴏᴅᴇʀ` }, { quoted: citel })
        }
    )
    //---------------------------------------------------------------------------
cmd({
